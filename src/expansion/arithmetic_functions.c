# 0 "src/expansion/arithmetic_functions.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/expansion/arithmetic_functions.c"
...
# 2 "src/expansion/arithmetic_functions.c" 2
...
# 3 "src/expansion/arithmetic_functions.c" 2
...
# 4 "src/expansion/arithmetic_functions.c" 2
...
# 5 "src/expansion/arithmetic_functions.c" 2
...
# 7 "src/expansion/arithmetic_functions.c" 2
...
# 8 "src/expansion/arithmetic_functions.c" 2

# 1 "./src/util/my_string.h" 1
# 10 "src/expansion/arithmetic_functions.c" 2
...
# 12 "src/expansion/arithmetic_functions.c" 2
# 1 "./src/util/my_math.h" 1



long int my_pow(long int n, long int p);
# 13 "src/expansion/arithmetic_functions.c" 2
...
# 14 "src/expansion/arithmetic_functions.c" 2
...
struct vector* a_lexer(char* exp, struct hash_table *ht[])
{
  ...
  for (i = 0; i < my_strlen(exp); i++)
    if (!lexer_loop(exp, &start_tok, &in_tok, v_tok, &i, ht))
      return 
# 144 "src/expansion/arithmetic_functions.c" 3 4
            ((void *)0)
# 144 "src/expansion/arithmetic_functions.c"
                ;
