# 0 "src/expansion/stack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/expansion/stack.c"
...
# 5 "src/expansion/arithmetic.h" 2
...
void stack_o_destroy(stack_operator **ptr_s)
{
  while (stack_o_size(*ptr_s) > 0)
    stack_o_pop(ptr_s);
  *ptr_s = 
# 49 "src/expansion/stack.c" 3 4
          ((void *)0)
# 49 "src/expansion/stack.c"
              ;
}
...
void stack_r_destroy(stack_result **ptr_s)
{
  while (stack_r_size(*ptr_s) > 0)
    stack_r_pop(ptr_s);
  *ptr_s = 
# 92 "src/expansion/stack.c" 3 4
          ((void *)0)
# 92 "src/expansion/stack.c"
              ;
}
