# 0 "src/expansion/expansion.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/expansion/expansion.c"
...
# 10 "src/expansion/expansion.c" 2

# 1 "./src/lexer/tokenize.h" 1
...
# 6 "./src/lexer/tokenize.h" 2


# 7 "./src/lexer/tokenize.h"
enum expansion_type
{
  NO_EXPANSION = -1,
  ARI,
...
# 12 "src/expansion/expansion.c" 2
# 1 "src/expansion/arithmetic.h" 1
...
# 1 "src/expansion/stack.h" 1



# 1 "/usr/lib/gcc/x86_64-linux-gnu/13/include/stddef.h" 1 3 4
# 5 "src/expansion/stack.h" 2
...
# 9 "src/expansion/arithmetic.h" 2
...
# 13 "src/expansion/expansion.c" 2
...
# 14 "src/expansion/expansion.c" 2
...
# 15 "src/expansion/expansion.c" 2
# 1 "./src/util/my_string.h" 1
# 16 "src/expansion/expansion.c" 2
# 1 "./src/main/main.h" 1
# 26 "./src/main/main.h"
struct shell_tools
{
...
void exit_42sh(void);
# 17 "src/expansion/expansion.c" 2
...
struct vector* expand(char* input, int in_ari_exp, struct hash_table *ht[])
{
  ...
  for (i_input = 0; input[i_input]; ++i_input)
  {
    if (!test_exp(input, output, &i_input, &start, ht, quoted, in_ari_exp))
      return 
# 82 "src/expansion/expansion.c" 3 4
            ((void *)0)
# 82 "src/expansion/expansion.c"
                ;
  }
  str_append(output, input + start, i_input - start, 0);
  free(input);
                     ...
                     struct str* output, int temp_err)
{
  ...
  char* file = 
# 102 "src/expansion/expansion.c" 3 4
              ((void *)0)
# 102 "src/expansion/expansion.c"
                  ;
  if (ret == 0)
  {
    ...
    file = mmap(
# 112 "src/expansion/expansion.c" 3 4
               ((void *)0)
# 112 "src/expansion/expansion.c"
                   , size_file, 
# 112 "src/expansion/expansion.c" 3 4
                                0x1
# 112 "src/expansion/expansion.c"
                         ...
                         struct str* output)
{
  ...
  cmd_tools.v_token = 
# 126 "src/expansion/expansion.c" 3 4
                     ((void *)0)
# 126 "src/expansion/expansion.c"
                         ;
  cmd_tools.ast = 
# 127 "src/expansion/expansion.c" 3 4
                 ((void *)0)
# 127 "src/expansion/expansion.c"
                     ;
  ...
  int std_out = dup(1);
  int std_err = dup(2);
  int temp_out = open("temp_out", 
# 133 "src/expansion/expansion.c" 3 4
                                 02000000 
# 133 "src/expansion/expansion.c"
                                           | 
# 133 "src/expansion/expansion.c" 3 4
                                             02 
# 133 "src/expansion/expansion.c"
...
# 133 "src/expansion/expansion.c"
                                                                       , 0666);
  int temp_err = open("temp_err", 
# 134 "src/expansion/expansion.c" 3 4
                                 02000000 
# 134 "src/expansion/expansion.c"
                                           | 
# 134 "src/expansion/expansion.c" 3 4
                                             02 
# 134 "src/expansion/expansion.c"
...
{
  char* new = 
# 155 "src/expansion/expansion.c" 3 4
             ((void *)0)
# 155 "src/expansion/expansion.c"
                 ;
  size_t new_size = 1;
...
static char* parameter_expansion(char* param_name, struct hash_table *ht[])
{
  ...
  free(param_name);
  if (param_value == 
# 184 "src/expansion/expansion.c" 3 4
                    ((void *)0)
# 184 "src/expansion/expansion.c"
                        )
  {
