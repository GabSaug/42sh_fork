# 0 "src/expansion/arithmetic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/expansion/arithmetic.c"
...
# 2 "src/expansion/arithmetic.c" 2
...
# 3 "src/expansion/arithmetic.c" 2
...
# 4 "src/expansion/arithmetic.c" 2
...
# 5 "src/expansion/arithmetic.c" 2
...
# 7 "src/expansion/arithmetic.h" 2
...
# 8 "src/expansion/arithmetic.h" 2
...
# 7 "src/expansion/arithmetic.c" 2
...
# 8 "src/expansion/arithmetic.c" 2

# 1 "./src/util/my_string.h" 1
# 10 "src/expansion/arithmetic.c" 2
...
# 12 "src/expansion/arithmetic.c" 2
# 1 "./src/util/my_math.h" 1



long int my_pow(long int n, long int p);
# 13 "src/expansion/arithmetic.c" 2
...
# 14 "src/expansion/arithmetic.c" 2
...
{
  stack_operator* s_operator = 
# 213 "src/expansion/arithmetic.c" 3 4
                              ((void *)0)
# 213 "src/expansion/arithmetic.c"
                                  ;
  stack_result* s_result = 
# 214 "src/expansion/arithmetic.c" 3 4
                          ((void *)0)
# 214 "src/expansion/arithmetic.c"
                              ;
  int unary = 1;
  int last_num = 0;
...
char* arithmetic_expansion(char* s, struct hash_table *ht[])
{
  ...
  if (!v_tok)
    return 
# 250 "src/expansion/arithmetic.c" 3 4
          ((void *)0)
# 250 "src/expansion/arithmetic.c"
              ;
  long int res;
  ...
  if (!success)
    return 
# 256 "src/expansion/arithmetic.c" 3 4
          ((void *)0)
# 256 "src/expansion/arithmetic.c"
              ;
