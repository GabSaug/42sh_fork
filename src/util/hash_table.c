# 0 "src/util/hash_table.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/util/hash_table.c"
...
struct hash_table *create_hash(size_t capacity)
{
  ...
  if (!new)
    return 
# 21 "src/util/hash_table.c" 3 4
          ((void *)0)
# 21 "src/util/hash_table.c"
              ;
  ...
  if (!new->table)
  {
    free(new);
    return 
# 28 "src/util/hash_table.c" 3 4
          ((void *)0)
# 28 "src/util/hash_table.c"
              ;
  }
...
struct hash_table *add_hash(struct hash_table *ht, char *key, void *data)
{
  ...
  else
  {
    ...
    if (!new)
      return 
# 100 "src/util/hash_table.c" 3 4
            ((void *)0)
# 100 "src/util/hash_table.c"
                ;
...
void *get_data(struct hash_table *ht, char *key)
{
  ...
  if (found)
    ...
    return 
# 123 "src/util/hash_table.c" 3 4
          ((void *)0)
# 123 "src/util/hash_table.c"
              ;
}
...
struct hash_table *cpy_hash(struct hash_table *ht)
{
  ...
  if (!res)
    return 
# 168 "src/util/hash_table.c" 3 4
          ((void *)0)
# 168 "src/util/hash_table.c"
              ;
