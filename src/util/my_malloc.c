# 0 "src/util/my_malloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/util/my_malloc.c"
...
# 5 "src/util/my_malloc.c" 2

void *my_malloc(size_t size)
{
  void* ptr = calloc(size, 1);
  if (ptr == 
# 9 "src/util/my_malloc.c" 3 4
            ((void *)0)
# 9 "src/util/my_malloc.c"
                )
    exit(1);
  return ptr;
}
