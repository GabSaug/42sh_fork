...
void tree_add_non_terminal_child(struct tree* tree, struct tree* child)
{
  if (child->nts >= LIST_AUX)
  {
    ...
    v_destroy(child->child, 
# 134 "src/util/tree.c" 3 4
                           ((void *)0)
# 134 "src/util/tree.c"
                               );
    free(child);
