# 0 "src/util/my_string.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/util/my_string.c"
...
char* my_strdup(char* s)
{
  if (!s)
    return 
# 39 "src/util/my_string.c" 3 4
          ((void *)0)
# 39 "src/util/my_string.c"
              ;
...
char* my_strndup(char* s, size_t n)
{
  if (!s)
    return 
# 55 "src/util/my_string.c" 3 4
          ((void *)0)
# 55 "src/util/my_string.c"
              ;
...
int update_quote(char c, char quoted[])
{
  ...
  if (c == '\'' && !quoted[BACKSLASH] && !quoted[DOUBLE_QUOTE])
  {
    ...
    return 2 * quoted[SINGLE_QUOTE] - 1;
  }
  if (c == '"' && !quoted[BACKSLASH] && !quoted[SINGLE_QUOTE])
  {
    quoted[DOUBLE_QUOTE] = !quoted[DOUBLE_QUOTE];
    return 2 * quoted[DOUBLE_QUOTE] - 1;
  }
  return 0;
}
