# 0 "src/lexer/tokenize.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/lexer/tokenize.c"
...
struct expansion tokenize_expansion(char* s, int in_ari_exp)
{
  ...
  if (exp.type == NO_EXPANSION)
  {
    exp.size = 0;
    exp.content_start = 
# 203 "src/lexer/tokenize.c" 3 4
                       ((void *)0)
# 203 "src/lexer/tokenize.c"
                           ;
  }
  return exp;
}
