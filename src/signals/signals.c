# 0 "src/signals/signals.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/signals/signals.c"
...
void exit_42sh(void);
# 13 "src/signals/signals.c" 2
# 1 "./src/util/my_string.h" 1
# 14 "src/signals/signals.c" 2
...
static void sigint(int signum, siginfo_t* siginfo, void* data)
{
  ...
  {
    write(
# 23 "src/signals/signals.c" 3 4
         2
# 23 "src/signals/signals.c"
                      , "\n", 1);
    print_prompt();
    rl_line_buffer[0] = ' ';
    rl_line_buffer[1] = '\0';
...
void set_sigacts(void)
{
  ...
  sigact.
# 38 "src/signals/signals.c" 3 4
        __sigaction_handler.sa_sigaction 
# 38 "src/signals/signals.c"
                     = sigint;
  sigemptyset(&(sigact.sa_mask));
  sigact.sa_flags = 0;
  if (sigaction(
# 41 "src/signals/signals.c" 3 4
               2
# 41 "src/signals/signals.c"
                     , &sigact, 
# 41 "src/signals/signals.c" 3 4
                                ((void *)0)
# 41 "src/signals/signals.c"
