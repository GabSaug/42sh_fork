# 0 "src/execute/builtins2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/builtins2.c"
...
# 7 "./src/option_parser/option_parser.h" 2
...
int builtin_shopt(char *argv[], struct hash_table *ht[])
{
  ...
  if (argv[1] == 
# 73 "src/execute/builtins2.c" 3 4
                ((void *)0)
# 73 "src/execute/builtins2.c"
                    )
  {
    for (size_t i = 0; i < sizeof (names) / sizeof (char*); i++)
    {
      ...
      if (val != 
# 78 "src/execute/builtins2.c" 3 4
                ((void *)0)
# 78 "src/execute/builtins2.c"
                    )
