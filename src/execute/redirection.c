# 0 "src/execute/redirection.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/redirection.c"
...
# 2 "src/execute/redirection.c" 2
# 1 "./src/util/my_string.h" 1
# 3 "src/execute/redirection.c" 2
...
# 45 "src/execute/redirection.c" 3 4
                          02 
# 45 "src/execute/redirection.c"
                                 | 
# 45 "src/execute/redirection.c" 3 4
                                   0100 
# 45 "src/execute/redirection.c"
...
# 55 "src/execute/redirection.c" 3 4
                         01 
# 55 "src/execute/redirection.c"
                                  | 
# 55 "src/execute/redirection.c" 3 4
                                    0100 
# 55 "src/execute/redirection.c"
...
# 55 "src/execute/redirection.c"
    ...
    return open_and_redir(fd_ionum == -1 ? 0 : fd_ionum, file_name, 
# 57 "src/execute/redirection.c" 3 4
                                                                   00
# 57 "src/execute/redirection.c"
                                                                           );
  else if (sign == DGREAT)
    return open_and_redir(fd_ionum == -1 ? 1 : fd_ionum, file_name,
                          
# 60 "src/execute/redirection.c" 3 4
                         01 
# 60 "src/execute/redirection.c"
                                  | 
# 60 "src/execute/redirection.c" 3 4
                                    02000
# 60 "src/execute/redirection.c"
    ...
    if (son->nts == REDIRECTION)
    {
      ...
      *fd = read_redirection(son);
      if (*fd == - 2)
      {
        ...
        return 
# 111 "src/execute/redirection.c" 3 4
              ((void *)0)
# 111 "src/execute/redirection.c"
                  ;
      }
      else if (*fd == - 1)
        free(fd);
