# 0 "src/execute/builtins.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/builtins.c"
...
int (*builtin_fun_match (char* s)) (char* argv[], struct hash_table *ht[])
{
  ...
  return 
# 43 "src/execute/builtins.c" 3 4
        ((void *)0)
# 43 "src/execute/builtins.c"
            ;
}
...
{
  char* ret_string = 
# 48 "src/execute/builtins.c" 3 4
                    ((void *)0)
# 48 "src/execute/builtins.c"
                        ;
  if (argv[1])
    ret_string = argv[1];
  if (ret_string == 
# 51 "src/execute/builtins.c" 3 4
                   ((void *)0)
# 51 "src/execute/builtins.c"
                       )
...
{
  if (argv[1] == 
# 83 "src/execute/builtins.c" 3 4
                ((void *)0)
# 83 "src/execute/builtins.c"
                    )
  {
    char* home = get_data(ht[VAR], "HOME");
    if (home == 
# 86 "src/execute/builtins.c" 3 4
               ((void *)0) 
# 86 "src/execute/builtins.c"
                    || home[0] == '\0')
    {
  ...
  if (chdir(directory) == 0)
  {
    ...
    add_hash(ht[VAR], "PWD", getcwd(
# 96 "src/execute/builtins.c" 3 4
                                   ((void *)0)
# 96 "src/execute/builtins.c"
                                       , 0));
    return 0;
  }
  return 1;
...
static int builtin_cd(char* argv[], struct hash_table *ht[])
{
  if (argv[1] && !strcmp(argv[1], "-"))
  {
    ...
    add_hash(ht[VAR], "OLDPWD", get_data(ht[VAR], "PWD"));
    add_hash(ht[VAR], "PWD", getcwd(
# 115 "src/execute/builtins.c" 3 4
                                   ((void *)0)
# 115 "src/execute/builtins.c"
                                       , 0));
    return 0;
  }
...
static int builtin_echo(char* argv[], struct hash_table *ht[])
{
  ...
  if (!opt_n)
    printf("\n");
  fflush(
# 255 "src/execute/builtins.c" 3 4
        stdout
# 255 "src/execute/builtins.c"
              );
  return 0;
}
