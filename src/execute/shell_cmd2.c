# 0 "src/execute/shell_cmd2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/shell_cmd2.c"
# 1 "/usr/include/fnmatch.h" 1 3 4
# 56 "/usr/include/fnmatch.h" 3 4

# 56 "/usr/include/fnmatch.h" 3 4
extern int fnmatch (const char *__pattern, const char *__name, int __flags);
# 2 "src/execute/shell_cmd2.c" 2
...
int execute_case(struct tree *ast, struct hash_table *ht[])
{
  ...
  char *word = expand_word(expand(my_strdup(var->token->s), 0, ht));
