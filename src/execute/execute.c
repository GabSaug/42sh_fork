# 0 "src/execute/execute.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/execute.c"
...
int execute_and_or(struct tree* ast, struct hash_table *ht[])
{
  ...
  do {
    ...
    if ((operator->token->id == AND_IF && ret != 
# 18 "src/execute/execute.c" 3 4
                                                0
# 18 "src/execute/execute.c"
                                                            )
        || (operator->token->id == OR_IF && ret == 
# 19 "src/execute/execute.c" 3 4
                                                  0
# 19 "src/execute/execute.c"
                                                              ))
      i += 2;
    i++;
