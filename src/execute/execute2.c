# 0 "src/execute/execute2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/execute/execute2.c"
...
# 4 "src/execute/execute2.c" 2
# 1 "./src/util/my_string.h" 1
# 5 "src/execute/execute2.c" 2
...
static int execute_bin(char** argv)
{
  ...
  else
  {
    ...
    return 
# 44 "src/execute/execute2.c" 3 4
          (((
# 44 "src/execute/execute2.c"
          exit_status
# 44 "src/execute/execute2.c" 3 4
          ) & 0xff00) >> 8)
# 44 "src/execute/execute2.c"
                               ...
                               struct hash_table *ht[])
{
  ...
  for (size_t j = index_start; j < v_size(ast->child); j++)
  {
    ...
    if (son->nts != REDIRECTION)
    {
      ...
      if (!v_arg_tmp)
        return 
# 62 "src/execute/execute2.c" 3 4
              ((void *)0)
# 62 "src/execute/execute2.c"
                  ;
      ...
      v_destroy(v_arg_tmp, 
# 67 "src/execute/execute2.c" 3 4
                          ((void *)0)
# 67 "src/execute/execute2.c"
                              );
    }
  }
  ...
  args[v_size(v_args)] = 
# 73 "src/execute/execute2.c" 3 4
                        ((void *)0)
# 73 "src/execute/execute2.c"
                            ;
  v_destroy(v_args, 
# 74 "src/execute/execute2.c" 3 4
                   ((void *)0)
# 74 "src/execute/execute2.c"
                       );
  return args;
}
...
{
  int res = 0;
  struct vector *to_close = 
# 155 "src/execute/execute2.c" 3 4
                           ((void *)0)
# 155 "src/execute/execute2.c"
                               ;
  int std_in = dup(0);
  int std_out = dup(1);
  int std_err = dup(2);
  ...
  {
    struct tree* element = v_get(ast->child, i);
