...
# 52 "/usr/include/readline/history.h" 3 4
...
# 77 "/usr/include/readline/history.h" 3 4
...
# 182 "/usr/include/readline/history.h" 3 4
...
# 236 "/usr/include/readline/history.h" 3 4
...
# 18 "src/main/main.c" 2
# 1 "./src/signals/signals.h" 1
...
static char* prompt = 
# 32 "src/main/main.c" 3 4
                     ((void *)0)
# 32 "src/main/main.c"
                         ;
static struct shell_tools* main_tools = 
# 33 "src/main/main.c" 3 4
                                       ((void *)0)
# 33 "src/main/main.c"
                                           ;
...
int main(int argc, char* argv[])
{
  ...
  tools->sub_shell = 0;
  tools->v_token = 
# 55 "src/main/main.c" 3 4
                  ((void *)0)
# 55 "src/main/main.c"
                      ;
  tools->ast = 
# 56 "src/main/main.c" 3 4
              ((void *)0)
# 56 "src/main/main.c"
                  ;
...
static int process_file(struct shell_tools* tools)
{
  int ret = 0;
  processing = 1;
  int fd = open(tools->option.input, 
# 125 "src/main/main.c" 3 4
                                    00 
# 125 "src/main/main.c"
                                             | 
# 125 "src/main/main.c" 3 4
